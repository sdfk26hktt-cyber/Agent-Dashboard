...
export default function ProspectTracker({ agentId, currentPoints, prospects }: { agentId: string, currentPoints: number, prospects: Prospect[] }) {
  ...
  return (
    <div style={{ marginTop: '2rem', padding: '1.5rem', backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '8px' }}>
      ...
      <p style={{ fontSize: '0.875rem', color: '#64748b', marginBottom: '1.5rem' }}>Track your active prospects and see your estimated graduation progress.</p>
      
      {/* Estimator Header */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '1.5rem', borderBottom: '1px solid #e2e8f0', marginBottom: '1.5rem' }}>
