...
export default function AdminEditProfileForm({ agent }: { agent: { id: string, name: string, email: string | null } }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setMessage('')
    try {
      await editAgentProfile(agent.id, name, email, password || undefined)
